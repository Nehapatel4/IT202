...
$dbuser = "nmp4";//your ucid since we follow this pattern
$dbpass = "Popat@me990";//database password generated or chosen per respective steps
$dbdatabase = "nmp4";//your ucid since we follow this pattern
?>