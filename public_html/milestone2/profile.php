...
if (isset($_POST["saved"])) {
    ...
    $stmt = $db->prepare("UPDATE INTO Users firstname :firstname WHERE id=:id");
    $r = $stmt->execute([
       ":firstname"=>$firstname,":id" => get_user_id()]); 
...
<form method="POST">
  ...
  <input type="text" name="lastname" placeholder="Last Name"/>
	<input type="hidden" name="lastname" value="<?php echo $_GET['lasttname'];?>"/>
